...
#root = os.getcwd()
'''
It should have a folder named 'PATH_TO_CITYSCAPES/cityscapes/'

The following should be downloaded in that folder from cityscapes:
gtFine_trainvaltest and leftImg8bit_trainvaltest.

'''
root = os.path.join(os.getcwd(),'/scratch/')                   ## PATH_TO_CITYSCAPES_DATASET
